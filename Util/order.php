...
$subtotal =($products[$i]->productprice)*($products[$i]->quantity);
$Total=$subtotal+($products[$i]->productprice)*($products[$i]->quantity);
// var_dump($Total);
    }
?>
        ...
        <div class="card-header bg-white">
            <div class="media flex-sm-row flex-column-reverse justify-content-between ">
                <div class="col my-auto">
                 <a href="../User/nav.php"><h4>Visit Again.. To our Store <h4></a>
            ...
            <div class="row">
                <div class="col">
                    <div class="card card-2">
                        <div class="card-body">
                            <div class="media">
                                <div class="sq align-self-center "> <img class="img-fluid my-auto align-self-center mr-2 mr-md-4 pl-0 p-0 m-0" src="<?= $prods->image; ?>" width="135" height="135" /> </div>
                                <div class="media-body my-auto text-right">
                                    <div class="row my-auto flex-column flex-md-row">
                                        <div class="col my-auto">
                                            <h6 class="mb-0"> <?= $prods->productname; ?></h6>
                                        </div>
                                        ...
                                        <div class="col my-auto">
                                            <h6 class="mb-0">&#8377;<?= $prods->productprice; ?></h6>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="jumbotron-fluid">
                <div class="row justify-content-between ">
                    ...
                    <div class="col-auto my-auto ">
                        <h2 class="mb-0 font-weight-bold">TOTAL AMOUNT</h2>
                    </div>
                    <div class="col-auto my-auto ml-auto">
                        <h1 class="display-3 " style="color: black">&#8377; <?php echo $Total?></h1>
                    </div>
                </div>
